...
/**
 * CardTable - Responsive Table Component
 *
 * Renders Semi-UI Table component on desktop, and renders each row as a Card on mobile.
 * This component maintains API consistency with the Table component - simply replace Table with CardTable.
 */
const CardTable = ({
  columns = [],
  dataSource = [],
