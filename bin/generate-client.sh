...
uv run python -c "from svc.main import app; import json; print(json.dumps(app.openapi()))" > apps/web/openapi.json

echo "✓ OpenAPI specification extracted"
echo ""

# Generate client from project root using bun filter
echo "Generating TypeScript client code..."
bun run --filter '@data-labeling/web' openapi-ts
...
echo "================================================"
echo ""
echo "Generated files in: apps/web/src/client/"
